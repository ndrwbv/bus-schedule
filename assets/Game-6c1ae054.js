import{j as u,a as t,F as he,l as me,b as ge,L as pe,A as L,B as xe,G as Se,c as be,W as we}from"./index-5f603061.js";import{s as d,S as ne,u as X,m as Te,r as a,L as ye}from"./vendor-9e9331ee.js";import{G as S,a as Ie,T as I,M as k,H as ve,b as J,c as K,d as Me,e as Ce}from"./index-a2191bff.js";const Q=4,Ee=3,x=4,Y=0,Z=0,ee=1,te=!1,se=500,Ne="/assets/game-star-69857334.svg",Ge="/assets/game-new-high-score-8104d64c.svg",$e=d.div`
	position: relative;
...
`,oe=({score:e,plusNumber:s,isBig:i,isNewHighScore:r=!1})=>{const n=i?85:45;return u($e,{isBig:!!i,children:[t(Le,{children:e}),t(ke,{animate:s.length!==0,children:s}),t(Re,{isBig:!!i,children:t(ne,{src:r?Ge:Ne,width:n,height:n,uniquifyIDs:!0})})]})},Be="/assets/game-record-d7c6bb6a.svg",ae=d.div`
	display: flex;
...
`;d.span`
	...
	color: white;
	font-weight: bold;
`;const Pe=({bgcolor:e,completed:s})=>t(Ae,{children:t(je,{bgcolor:e,style:{width:`${s}%`}})}),Ve=e=>e>=14?x*6:e>=12?x*5:e>=9?x*4:e>=5?x*3:e>=2?x*2:(e>=1,x),Fe=localStorage.getItem("devMode")==="1",Je=()=>{const[e]=Te(),[s,i]=a.useState(R(Q)),[r,n]=a.useState(Y),[g,b]=a.useState(Z),[f,O]=a.useState(ee),[h,v]=a.useState(te),[M,le]=a.useState(new Date().getTime()),[c,_]=a.useState(B(M)),[T,C]=a.useState(!0),[A,E]=a.useState(!0),[N,j]=a.useState(!1),[y,P]=a.useState(!1),[w,de]=a.useState(localStorage.getItem("score")?Number(localStorage.getItem("score")):0),[G,V]=a.useState(!1);a.useEffect(()=>{G&&h&&(localStorage.setItem("score",r.toString()),de(r))},[G,h,r]),a.useEffect(()=>{r>w&&V(!0),!h&&g>Ee&&v(!0)},[g,h,r,w]),a.useEffect(()=>{!h&&c.seconds===0&&v(!0)},[c,h]),a.useEffect(()=>{if(c.seconds===0)return;const o=setTimeout(()=>{_(B(M,f*.11))},10);return()=>clearTimeout(o)},[c,f,M]);const F=()=>{v(te),_(B(new Date().getTime(),.15)),i(R(Q)),n(Y),O(ee),b(Z),le(new Date().getTime()),C(!0),E(!0),P(!1),V(!1),L("game.newGame")},ue=o=>{o.destroyed||o.selected||i(p=>{const m=p.find(l=>l.selected),$=m?p.find(l=>m.text===l.text&&m.id!==l.id&&o.id===l.id):void 0,q=m&&!$,U=m&&$;return q&&(b(l=>l+1),E(!0)),U&&n(l=>l+1),p.map(l=>q?{...l,selected:!1}:U&&(l.id===m.id||$.id===l.id)?{...l,selected:!1,destroyed:!0}:l.id===o.id?{...l,selected:!0}:l)})};a.useEffect(()=>{let o=null;return T&&(o=setTimeout(()=>{C(!1),!y&&P(!0)},se)),()=>clearTimeout(o)},[T,y]),a.useEffect(()=>{let o=null;return A&&(o=setTimeout(()=>{E(!1)},se)),()=>clearTimeout(o)},[A]),a.useEffect(()=>{let o=null;return N&&(o=setTimeout(()=>{j(!1)},500)),()=>clearTimeout(o)},[N]),a.useEffect(()=>{if(s.every(p=>p.destroyed===!0)){O(m=>m+1);const p=Ve(f);i(R(p)),C(!0),L("game.newLevel")}},[s,f]),a.useEffect(()=>{j(!0)},[r]);const fe=()=>c.seconds===0||c.seconds===1?100:c.seconds===2?95:c.seconds===3?80:c.seconds===4?70:c.seconds===5?60:c.seconds===6?50:c.seconds===7?40:c.seconds===8?30:c.seconds===9?20:c.seconds===10?10:c.seconds*60/100;return G&&h?t(k,{isWin:!1,bg:ve,children:u(J,{children:[t(S,{children:t(I,{children:"Новый рекорд"})}),t(H,{plusNumber:"",score:w,level:f,isGameOver:!0,isNewHighScore:!0}),t(K,{onClick:F,children:"Играть еще"})]})}):h&&!Fe?t(k,{isWin:!1,bg:Me,children:u(J,{children:[t(xe,{children:t(ye,{to:`/?${e.toString()}`,onClick:()=>L("game.backToSchedule"),children:"Вернуться к расписанию"})}),t(S,{children:t(I,{children:"Продолжим?"})}),t(H,{plusNumber:"",score:r,bestScore:w,level:f,isGameOver:h}),t(K,{onClick:F,children:"Играть еще"})]})}):t(k,{isWin:y?T:!1,children:u(Ce,{children:[t(Pe,{completed:fe(),bgcolor:"#F48400"}),t(Oe,{plusNumber:N&&y?"+1":"",score:r,miss:g,level:f,timeLeft:c,bestScore:w}),t(Se,{animate:T,children:s.map(o=>t(be,{onClick:()=>ue(o),$selected:o.selected,$destroyed:o.destroyed,children:o.text},o.id))}),t(we,{children:"Выбирай одинаковые блоки пока все не закончатся"})]})})};export{Je as default};
