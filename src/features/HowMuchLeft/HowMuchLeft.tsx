...
interface ILeftProps {
	left: ITime
	busStoLabel: StopKeys | null
	shouldShowFastReply: boolean
	holiday: IHoliday | null
	onComplain: (key: ComplainType) => void
}
export const HowMuchLeft: React.FC<ILeftProps> = ({ left, busStoLabel, shouldShowFastReply, holiday, onComplain }) => {
		...
		<>
			<HowMuchLeftContainerStyled isFancy={isFancy} defaultColor={getColorByLeftTime()}>
				<NextBusContainerStyled>
					...
					<BusEstimationStyled>
						<LeftToString busStop={busStoLabel} left={left} />
					</BusEstimationStyled>
				</NextBusContainerStyled>
			</HowMuchLeftContainerStyled>
